...
class Main:
    def __init__(self, master):
        ...
        self.imgMain = ImageTk.PhotoImage(Image.open("images/pass.jpg"))
        Label(self.master, image=self.imgMain).pack()
...
class SignUp(Main):
    ...
    def __init__(self, window):
        ...
        self.imgSign = ImageTk.PhotoImage(Image.open("images/form.jpg"))
        Label(self.window, image=self.imgSign).pack(pady=10)
        self.sign_lbl()
...
class Login(Main):
    def __init__(self, window):
        ...
        self.sign_up_lbl.pack(side=TOP, padx=10, pady=30)
        self.imgLogin = ImageTk.PhotoImage(Image.open("images/form.jpg"))
        Label(self.window, image=self.imgLogin).pack(pady=10)
        self.log_lbl()
